    ...
    <div>
        <div className='w-full bg-white'>
            <div className='mx-auto max-w-screen-2xl lg:px-8'>
                <div className='flex flex-col justify-center px-0 py-0 lg:px-6'>
                    <Image
                    ...
                    <div className='mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-16 xl:px-32'>
                        <h2 className='text-2xl sm:text-3xl leading-10 font-bold py-4 lg:py-8'>The Heritage Continued by the Third Generation</h2>
                        <p className='leading-7 text-gray-700'>Today, the proud heritage of Nuzrat Carpet Emporium is upheld by the third generation of the family—Mr. Raju Ansari and Mr. Shah Alam, the grandsons of Haji Arman Ali and sons of Abdul Sattar. Both leaders bring not only business acumen but also a deep personal connection to the craft. Having learned the weaving process themselves, they possess a unique advantage: the ability to manage the company from the perspective of both artisans and entrepreneurs.
                        </p>

                        <p className='py-4 leading-7 text-gray-700'>Their presence on the production floor, close involvement in design development, and direct communication with international clients ensure that quality, innovation, and customer satisfaction remain the hallmarks of the company. Unlike many large-scale manufacturers, Nuzrat Carpet Emporium remains a family-run business, where every decision is taken with care and every product is overseen with personal attention.</p>
                    </div>

                    <div className='mx-auto max-w-7xl w-full px-4 py-6 sm:px-6 lg:px-16 xl:px-32'>
                        <h2 className='text-2xl sm:text-3xl leading-10 font-bold py-4 lg:py-8'>Our Products &amp; Expertise</h2>

                        <p className='leading-7 text-gray-700'>Over the decades, Nuzrat Carpet Emporium has built a wide-ranging product portfolio that caters to global tastes and modern lifestyles while maintaining traditional roots.</p>

                        <ul className='py-3 leading-7 text-gray-700 px-5 list-disc space-y-1'>
                        ...
                        <p className='py-4 leading-7 text-gray-700'>Each product is developed with a focus on quality, durability, and elegance, making them suitable for both luxury interiors and everyday living spaces.</p>

                        <h2 className='py-2 text-2xl sm:text-3xl font-bold'>Global Reach &amp; Clientele</h2>
                        <p className='leading-7 text-gray-700'>Nuzrat Carpet Emporium has steadily grown from a local cottage industry to a global exporter. Our products are shipped to wholesalers, distributors, retail chains, designers, and institutions around the world. Our clientele includes:</p>
                        <ul className='py-2 leading-7 text-gray-700 font-medium px-5 list-disc space-y-1'>
                        ...
                        <p className='py-3 leading-7 text-gray-700'>The company has invested in modern infrastructure to ensure efficient and timely logistics. Whether by air, sea, or courier, we guarantee safe and reliable shipment of goods to destinations across Europe, the Middle East, North America, Asia, and beyond.</p>

                        <h2 className='py-2 text-2xl sm:text-3xl font-bold'>What Sets Us Apart</h2>
                        <ul className='leading-7 text-gray-700 px-5 list-disc space-y-1'>
                        ...
                        <h2 className='py-2 text-2xl sm:text-3xl font-bold'>Our Philosophy</h2>
                        <p className='leading-7 text-gray-700'>At Nuzrat Carpet Emporium, we believe that every carpet tells a story— a story of craftsmanship, heritage, and human touch. Our philosophy is simple yet powerful:</p>
                        
                        <p className='py-2 leading-7 text-gray-700 font-bold italic'>"Giving the best service is our first priority. We never compromise on quality. During work, our eyes are always the eyes of our customers."</p>
                    </div>

                    <div className='grid grid-cols-1 gap-4 sm:gap-8 sm:grid-cols-2 px-4 py-6 sm:px-6 lg:px-16 xl:px-32'>
                        <div>
                            <Image src={first} alt="" className="w-full object-cover h-[250px] sm:h-[350px] lg:h-[500px]"/>
                        </div>
                        <div>
                            <Image src={first} alt="" className="w-full object-cover h-[250px] sm:h-[350px] lg:h-[500px]"/>
                        </div>
